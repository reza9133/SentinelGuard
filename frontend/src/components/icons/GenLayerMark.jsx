/**
 * GenLayer's own wordmark logo, used to credit the network this app is
 * built on. Renders in `currentColor`, so it follows the surrounding
 * link's text color (including on hover).
 */
export default function GenLayerMark({ height = 16, className = "" }) {
