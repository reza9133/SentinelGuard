 ...
 *
 * The whole thing is memoized on [writeClient, walletAddress]: every page
 * takes this object as a prop and several put it straight into a
 * useEffect dependency array (to fetch on mount). Without memoizing here,
 * every render of <App> would hand out a brand-new object - identical in
 * behavior, but a new reference - and each of those effects would refire
 * on any unrelated state change upstream (e.g. opening the wallet modal),
 * refetching stats/targets/incidents for no reason.
 */
